...
export default function ChatBoxReciever({avatar , user , message}) {
  return (
    <div   style={{display:'flex' , flexDirection:'row',justifyContent:'flex-start' , marginLeft:'30px', padding:'10px'}} >
       ...
       <p className='shadow ms-2' style={{padding:'10px' , backgroundColor:'#dcf8c6', borderRadius:'10' , maxWidth:'60%', width:'10%', boxShadow:'10px 10px 5px lightblue', borderRadius:'6px' , }}>
...
export function ChatBoxSender({avatar , user , message}) {
  return (
    <div  className='me-4'   style={{display:'flex' , flexDirection:'row',justifyContent:'flex-end' , marginLeft:'30px', padding:'10px'}} >
       ...
       <p className='shadow ms-2' style={{padding:'10px' , backgroundColor:'#ffff', borderRadius:'10' , maxWidth:'60%', width:'10%', boxShadow:'10px 10px 5px lightblue', borderRadius:'6px' , }}>
        <strong style={{fontSize:'13'}}>
                  {user}
        </strong> <br /> 
        {message}
