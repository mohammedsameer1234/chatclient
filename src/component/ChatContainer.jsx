...
export default function ChatContainer() {
   let socketio = socketIOClient("https://whats-server-sun4.onrender.com")
  ...
  return (
    <div>
       ...
       <div style={{height:'70px'}} className='w-100 bg-secondary  shadow  d-flex  flex-row justify-content-between  '>
        ...
        <h3 className='text-light ' style={{margin:10, textAlign:'center'}}> <i class="fa-brands fa-facebook-messenger me-2"></i> Chat App </h3>
